...
WS.verifyElementPropertyValue(response, 'data.firstName', 'Senja')

WS.verifyElementPropertyValue(response, 'data.middleName', 'Ult')

WS.verifyElementPropertyValue(response, 'data.lastName', 'Van')

WS.verifyElementPropertyValue(response, 'data.code', '0023')

WS.verifyElementPropertyValue(response, 'data.fullName', 'Senja Ult Van')
